...
-   [x] As a user, I would like to see the vegetables/fruites that are currently in season.
...
-   [x] As a user, I would like to see more information about specific fruits and veg.
-   [x] As a user, I would like to see specific information about a recipe.
-   [x] As a user, I would like to see an overview of all recipe.
...
-   We ran a discovery session to understand what problem our users were facing.
...
-   Spend more time researching different technologies
-   Research technologies more thoroughly
